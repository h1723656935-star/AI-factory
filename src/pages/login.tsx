...
import { Sparkles, Mail, Lock, Eye, EyeOff, Chrome, Github } from 'lucide-react'
...
export default function LoginPage() {
  ...
  const { login, user, loading, error, clearError, signInWithOAuth } = useAuth()
  ...
  return (
    <Layout title="登录" description="登录爆款工厂AI账号，开启 AI 创作之旅">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="glass-card-dark p-8 border border-gold-500/20">
            <div className="text-center mb-8">
              ...
              <h1 className="font-orbitron text-2xl font-bold text-white mb-2">欢迎回来</h1>
              <p className="text-gray-400 text-sm">登录你的爆款工厂AI账号</p>
            </div>
            ...
            <div className="mt-6 flex items-center justify-between text-sm">
              ...
              <Link href="/register" className="text-gray-400 hover:text-white transition-colors">
                还没有账号？<span className="text-gold-500">注册</span>
              </Link>
            </div>
          </div>
        </div>
